  ...
  return (
    <>
      ...
      <section className="py-12 rounded-lg mx-4 my-2">
        <div className="container mx-auto px-4" style={{ width: "85%" }}>
          <h2 className="text-center text-white text-3xl font-bold mb-6 animate-fadeInUp">
            Our Leadership Team
          </h2>
          <div className="grid md:grid-cols-3 gap-6">
            {[{
            ...
            },
            {
              ...
              >
                <div className="relative overflow-hidden rounded-full w-40 h-40 mx-auto mb-4 group">
                  <img
                ...
                <div className="flex justify-center mt-4 space-x-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                  <a
                    href="#"
    ...
    <div className="grid md:grid-cols-3 gap-6">
      ...
      },
      {
        ...
        >
          ...
          <div className="relative mb-4 w-full h-56 group">
            <img
              src={article.image}
              alt={article.title}
          ...
          {/* Article Title */}
          <h3 className="font-bold text-lg mb-3 text-black" style={{ whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>
            {article.title}
          </h3>
        ...
        <div className="container mx-auto px-4 text-center" style={{ width: "65%" }}>
          <h2 className="text-3xl text-white font-bold mb-6">Stay Updated</h2>
          ...
          <form className="flex justify-center space-x-4">
            <input
              ...
              className="p-4 rounded-lg border text-black border-gray-300 w-80"
            />
            <button
              type="submit"
